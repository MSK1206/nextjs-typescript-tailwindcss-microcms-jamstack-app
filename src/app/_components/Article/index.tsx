...
export default function Article({ data }: Props) {
  return (
    <main id="top" role="main">
      <h1 className="text-center font-bold text-[20px] max-[796px]:text-[calc(100%+5px)] max-[844px]:text-[calc(100%+10px)] max-[896px]:text-[calc(100%+15px)] max-[1366px]:text-[calc(100%+25px)]">
        {data.title}
      </h1>
